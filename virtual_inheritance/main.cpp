...
int main() {
    ...
    cout << "Printing '*(ip+10)' (v-table pointer): " << *(ip + 10) << " and address: " << (ip + 10) << endl;
    cout << "Printing '*(ip+11)' value: " << *(ip + 11) << " and address: " << (ip + 11) << endl;
    cout << "Printing '*(ip+12)' value: " << *(ip + 12) << " and address: " << (ip + 12) << endl;
    cout << "Printing '*(ip+13)' value: " << *(ip + 13) << " and address: " << (ip + 13) << endl;
	cout << "---------------------------------" << endl;
